    ...
    <b-row>
      ...
      <div class="col ms-5">
        ...
        <div class="row mt-2 me-5 d-flex align-items-center justify-content-between">
          ...
          <div class="col-1 textStart">
            <i class="fa-solid fa-user-group"></i>
            {{ job.numVacancies }} {{ job.numVacancies > 1 ? 'Vacantes' : 'Vacante' }}
          </div>
          <div class=" col-1  textStart"><i class="fa-regular fa-calendar"></i> {{ job.date }}</div>
          <div class=" col-2">
            <span class="badge border rounded-pill bg-white text-dark p-2 mx-1" v-for="benefit in job.benefits"
              :key="benefit" variant="secondary" :title="benefit.benefit">
